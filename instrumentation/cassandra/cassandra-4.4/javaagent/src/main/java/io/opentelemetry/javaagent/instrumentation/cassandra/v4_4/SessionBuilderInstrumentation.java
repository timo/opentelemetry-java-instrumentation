...
public class SessionBuilderInstrumentation implements TypeInstrumentation {
  ...
  public static class BuildAdvice {
     ...
     * com.datastax.oss.driver.api.core.session.SessionBuilder.buildDefaultSessionAsync() method is
     * called. The opentracing contribution is a simple wrapper, so we just have to wrap the new
     * session.
     *
